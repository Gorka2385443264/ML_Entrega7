<section class="modal hidden">
    ...
    <div class="text">
        ...
        <div class="modal-question hidden">
            ...
            <div class="options">
                <div><input type="radio" name="answer" value="1">
                    <?= isset ($row["option1"]) ? $row["option1"] : "" ?>
                </div>
                <div><input type="radio" name="answer" value="2" checked>
                    <?= isset ($row["option2"]) ? $row["option2"] : "" ?>
                </div>
                <div><input type="radio" name="answer" value="3">
                    <?= isset ($row["option3"]) ? $row["option3"] : "" ?>
                </div>
            </div>
        </div>
